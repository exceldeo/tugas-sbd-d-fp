        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-4 ">
                        <p class="display-3 text-center" style="">Ubah Barang</p>
                    </div>
                ...
                <div class="row" style="margin-top:50px">
                    ...
                    <input type="hidden" name="id" value="<?= $data['id'];?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                            <input type="number" min="0" id="hargaB" class="form-control" name="hargaB" 
                            required autocomplete="off" value="<?= $data['hargaBeli'];?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="hargaJ" class="col-lg-2">Harga Jual: </label>
                            <div class="col-lg-10">
                            <input type="number" min="0" id="hargaJ" class="form-control" name="hargaJ" 
                            required autocomplete="off" value="<?= $data['hargaJual'];?>">
                            </div>
                        </div>
